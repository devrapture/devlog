...
export class DraftDataWrapperDto {
  @ApiProperty({ type: DraftDataDto })
  draft: DraftDataDto;
}

export class SingleDraftResponseDto {
  @ApiProperty({
    example: true,
  ...
  @ApiProperty({ type: DraftDataWrapperDto })
  data: DraftDataWrapperDto;
}
...
// with pagination
export class DraftResponseDtoWithPagination {
  @ApiProperty({
    example: true,
    description: 'Indicates if the request was successful',
  })
